...
MLA.Model = function () {
    ...
    var Quiz = function () {
        ...
        this.getTheHistory = function () {
            return theHistoryOfTheWorld;
        };
    ...
    var History = function (theQuestion, options, theAnswer, correct) {
        ...
        this.specGetCorrect = function () {
            return correct;
        };
        this.specGetQuestion = function () {
            return theQuestion;            
        };
        this.specGetOptions = function () {
            return options;
        };
        this.specGetTheAnswer = function () {
            return theAnswer;
        };
    };
    /**** Timer class ****/
    ...
    var getNextQuestion = function () {
        if (theUser.getQuiz().getWordArray().length > 0) {
            ...
            publishQuestion();
            console.log(theUser.getQuiz().getTheResource());
        } else {
